      ...
      if (data) {
        this.db.collection('users').find(data.id).fetch().defaultIfEmpty().subscribe(data2 => {
          if (data2) {
            ...
            if (this.userdataobj.points < 100) {
              // this.levelpic = 'assets/img/baby.png'
              this.nextlevel = 100 - this.userdataobj.points;
            } else if (this.userdataobj.points >= 100 && this.userdataobj.points < 500) {
              // this.levelpic = 'assets/img/young.png'
              this.nextlevel = 500 - this.userdataobj.points;
            } else if (this.userdataobj.points >= 500 && this.userdataobj.points < 1000) {
              // this.levelpic = 'assets/img/master.png'
              this.nextlevel = 1000 - this.userdataobj.points;
            } else if (this.userdataobj.points >= 1000 && this.userdataobj.points < 2000) {
              //this.levelpic = 'assets/img/king.png'
              this.nextlevel = 2000 - this.userdataobj.points;
            }
          }
        });
      }
